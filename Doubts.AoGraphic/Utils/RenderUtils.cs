...
using Doubts.AoGraphic.Dom;
using Doubts.AoGraphic.Entities;

namespace Doubts.AoGraphic.Utils
{
    /// <summary>
    ...
    internal static class RenderUtils
    {
        ...
        {
            if( _loadImage == null )
                _loadImage = Image.FromStream(typeof(HtmlContainer).Assembly.GetManifestResourceStream("Resources.LoadImage.png")); ;
            return _loadImage;
        }
        ...
        {
            if( _errorImage == null )
                _errorImage = Image.FromStream(typeof(HtmlContainer).Assembly.GetManifestResourceStream("Resources.ErrorImage.png")); ;
            return _errorImage;
        }
